...
export const IMAGE_SLOTS: ImageSlot[] = [
  ...
  { key: "innovation-principal", label: "Innovation · Banner principal", group: "Innovation", division: "Innovation", defaultSrc: "/innovation-hero-banner.png", dims: "1920 × 560 px" },
