...
export const TEXT_SLOTS: TextSlot[] = [
  ...
  // ---- Energy · Tienda (home) ----
  { key: "energy-productos-eyebrow", label: "Productos · Antetítulo", group: "Página de inicio", division: "Energy", defaultValue: "Productos destacados" },
  { key: "energy-productos-titulo", label: "Productos · Título", group: "Página de inicio", division: "Energy", defaultValue: "Energía solar lista para tu operación" },
  { key: "energy-productos-subtitulo", label: "Productos · Subtítulo", group: "Página de inicio", division: "Energy", defaultValue: "Paneles, inversores, baterías y estructuras para proyectos residenciales, comerciales e industriales.", multiline: true },
  { key: "energy-ofertas-eyebrow", label: "Ofertas · Antetítulo", group: "Página de inicio", division: "Energy", defaultValue: "Ofertas Energy" },
  { key: "energy-ofertas-titulo", label: "Ofertas · Título", group: "Página de inicio", division: "Energy", defaultValue: "Soluciones listas para instalar" },
  { key: "energy-oferta-1", label: "Oferta 1 · Texto", group: "Ofertas", division: "Energy", defaultValue: "Paneles solares" },
  { key: "energy-oferta-2", label: "Oferta 2 · Texto", group: "Ofertas", division: "Energy", defaultValue: "Baterías y respaldo" },
  { key: "energy-oferta-3", label: "Oferta 3 · Texto", group: "Ofertas", division: "Energy", defaultValue: "Estructuras de montaje" },
  { key: "energy-oferta-4", label: "Oferta 4 · Texto", group: "Ofertas", division: "Energy", defaultValue: "Instalación por proyecto" },
  { key: "energy-destacada-1", label: "Marca destacada 1 · Texto", group: "Marcas destacadas", division: "Energy", defaultValue: "Proyectos residenciales" },
  { key: "energy-destacada-2", label: "Marca destacada 2 · Texto", group: "Marcas destacadas", division: "Energy", defaultValue: "Proyectos comerciales" },
  { key: "energy-destacada-3", label: "Marca destacada 3 · Texto", group: "Marcas destacadas", division: "Energy", defaultValue: "Proyectos industriales" },
  { key: "energy-destacada-4", label: "Marca destacada 4 · Texto", group: "Marcas destacadas", division: "Energy", defaultValue: "Mantenimiento y monitoreo" },
  { key: "energy-marcas-titulo", label: "Título de sección de marcas", group: "Página de inicio", division: "Energy", defaultValue: "Nuestras soluciones destacadas" },
  { key: "energy-contacto-eyebrow", label: "Contacto · Antetítulo", group: "Página de inicio", division: "Energy", defaultValue: "¿Tienes un proyecto en mente?" },
  { key: "energy-contacto-titulo", label: "Contacto · Título", group: "Página de inicio", division: "Energy", defaultValue: "Hablemos de tu proyecto energético" },
  ...
  { key: "energy-hero-titulo", label: "Héroe · Título", group: "Proyectos", division: "Energy", defaultValue: "Creamos la energía del mañana" },
  { key: "energy-hero-subtitulo", label: "Héroe · Subtítulo", group: "Proyectos", division: "Energy", defaultValue: "Soluciones energéticas inteligentes para un futuro sostenible.", multiline: true },
  { key: "energy-soluciones-titulo", label: "Soluciones · Título", group: "Proyectos", division: "Energy", defaultValue: "Diseñamos soluciones a la medida de tus necesidades." },
  { key: "energy-sistema-eyebrow", label: "Sistema · Antetítulo", group: "Proyectos", division: "Energy", defaultValue: "Diseña tu sistema" },
  { key: "energy-sistema-titulo", label: "Sistema · Título", group: "Proyectos", division: "Energy", defaultValue: "Soluciones a la medida de tu proyecto." },
  { key: "energy-sistema-subtitulo", label: "Sistema · Subtítulo", group: "Proyectos", division: "Energy", defaultValue: "Simula, cotiza y diseña un sistema energético eficiente con la ayuda de nuestra tecnología y de Gus.", multiline: true },
  ...
  { key: "innovation-doypack-titulo", label: "Doypack · Título producto", group: "Innovation", division: "Innovation", defaultValue: "Tetrapack" },
  { key: "innovation-doypack-descripcion", label: "Doypack · Descripción producto", group: "Innovation", division: "Innovation", defaultValue: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.", multiline: true },
  { key: "innovation-doypack-uso-titulo", label: "Doypack · Título de uso", group: "Innovation", division: "Innovation", defaultValue: "Tetrapack" },
  { key: "innovation-doypack-uso-descripcion", label: "Doypack · Descripción de uso", group: "Innovation", division: "Innovation", defaultValue: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat, quis autem vel eum iure reprehenderit qui in ea voluptate.", multiline: true },
  { key: "innovation-doypack-uso-detalle", label: "Doypack · Detalle junto a la foto", group: "Innovation", division: "Innovation", defaultValue: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat.", multiline: true },
  { key: "innovation-doypack-uso-etiqueta", label: "Doypack · Etiqueta de uso", group: "Innovation", division: "Innovation", defaultValue: "Tetrapack" },
